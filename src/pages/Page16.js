    ...
    <div className="container">
      <Link to="/" className="back-button-flower">
          ...
          <div className="centered-title">
           <b>Porque tu familia tiene en ti a una persona increíble: </b> 
          Al conocer a tu familia, entendí lo mucho que te aman. Ellos no solo te han dado el amor que te rodea, sino que han criado a una niña tan generosa, bondadosa y compasiva que es la mujer de hoy en día.
      </div>
