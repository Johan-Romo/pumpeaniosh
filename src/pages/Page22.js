...
const Pag22 = () => {
  return (
    <div>
      ...
      <div id="texto1">
        <b>Porque siempre sabes sorprenderme: </b>
        A pesar de que te conozco bien, siempre logras sorprenderme. Con pequeños detalles, con palabras, con gestos, historias nuevas o con alguna locura tuya. Sabes sacarme una sonrisa y hacerme olvidar por un rato cualquier preocupación
        </div>
