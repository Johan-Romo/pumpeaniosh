    ...
    <div className="container">
      <Link to="/" className="back-button-flower">
          ...
          <div className="centered-title">
           <b>Porque tu amistad con los demás refleja lo linda que eres por dentro: </b> 
           Tus amigos tienen suerte de contar con alguien como tú en sus vidas, porque eres la amiga que todos desearían tener.
      </div>
